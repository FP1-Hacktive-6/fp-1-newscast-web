    ...
    return (
        ...
        <div className="p-6">
          ...
          <a className="inline-block" href={item.url}>
            <button
              className="transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-110  duration-300 flex select-none items-center gap-2 rounded-lg m-2 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-red-500  hover:bg-slate-50 active:bg-gray-500 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              type="button"
            >
              Read More
              <svg
